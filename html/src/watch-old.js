            ...
            <div class="video-sidebar-layout movie-content-wrapper">
                <div class="video-section">
                    <div class="video-container">
                        <iframe id="video-player" src="${embedUrl}" allowfullscreen sandbox="allow-forms allow-scripts allow-pointer-lock allow-same-origin allow-top-navigation"></iframe>
                    </div>
...
async function watchEpisode(seriesId, seasonNumber, episodeNumber) {
    ...
    if (player) {
        player.src = embedUrl;
        // Ensure sandbox is applied
        if (!player.hasAttribute('sandbox')) {
            player.setAttribute('sandbox', 'allow-forms allow-scripts allow-pointer-lock allow-same-origin allow-top-navigation');
        }
    }
